---
title: "出典情報ページ"
description: "本サービスで引用している気象庁データの引用元URL及び加工方法概要を記載します。"
---
## 出典情報
[気象庁ホームページのコンテンツの利用について](https://www.jma.go.jp/jma/kishou/info/coment.html)に基づき、本サービスで引用している気象庁データの引用元URL及び加工方法概要を記載します。
