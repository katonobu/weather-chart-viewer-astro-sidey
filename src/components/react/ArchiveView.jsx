...
export default function ArchiveView() {
    ...
    if (dirLoading || detailLoading) return <p className="p-4">読み込み中...</p>
    ...
    return (
        <div>
            ...
            <div>
                ...
                {
                    data.files.map((file) => (
                    <section key={file.id} id={file.id}>
            ...
            >
                <TextToSpeechCtrl texts={/*kaisetsuTexts*/""} viewtext={true}/>
            </div>
        </div>
    )
}
